...
const modalData = {
  ...
  animation4: { title: 'Lego Animation - Personal Project', desc: 'Focused on Sound design (planning to do the rescore of Star Wars music in the future). The stop-motion animation was created by - Levan Abashidze. Visit His Channel:<br><a href="https://www.youtube.com/@Le1cho" target="_blank" rel="noopener" class="modal-link">https://www.youtube.com/@Le1cho</a>', video: 'public/videos/LevanAnimation3.mp4', thumb: 'public/images/LevanAnimation3V1.png' },
